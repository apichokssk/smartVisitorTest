...
const mockGuardData: Record<string, { prefix: string; firstName: string; lastName: string; phone: string; position: string; factory: string; account: string }> = {
  "1": {
    prefix: "",
    firstName: "",
    lastName: "",
...
export default function EditGuardPage() {
  ...
  const initial = mockGuardData[id] || mockGuardData["1"]
        ...
        <main className="flex-1 ml-28 p-8 overflow-y-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center gap-2 mb-8 text-slate-800 font-semibold">
              ...
              <span>{isTH ? "แก้ไขข้อมูลรักษาความปลอดภัย" : "Edit Security Guard"}</span>
            </div>
